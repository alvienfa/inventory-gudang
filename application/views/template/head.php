          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown <?= (strpos(current_url(),'user/list')? 'active' : '') ?>">
                ...
                <ul class="dropdown-menu" style="<?= (strpos(current_url(),'user/list')? 'display:block' : '') ?>">
                  ...
                  <li class="<?= (strpos(current_url(),'list_barang_keluar')? 'active' : '') ?>"><a class="nav-link" href="<?= base_url('user/list_barang_keluar')?>">Barang Keluar</a></li>
                  <li class="<?= (strpos(current_url(),'list_barang_kembali')? 'active' : '') ?>"><a class="nav-link" href="<?= base_url('user/list_barang_kembali')?>">Barang Kembali</a></li>
                </ul>
              </li>  
            </ul>
        </aside>
