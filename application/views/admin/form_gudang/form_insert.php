        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Tambah Data Gudang</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_gudang_insert')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group" style="display:inline-block;">
                  ...
                  <input type="text" name="nama_gudang" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="nama_gudang" placeholder="Nama Gudang">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="detail_gudang" style="width:73%;">Detail Gudang</label>
                  <input type="text" name="detail_gudang" style="width:90%;margin-right: 67px;" class="form-control" id="detail_gudang" placeholder="Detail Gudang">
              </div>
              <div class="form-group" style="display:inline-block;">
