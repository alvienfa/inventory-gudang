          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?= base_url('admin/signout')?>" class="btn btn-default btn-flat"><i class="fa fa-cogs" aria-hidden="true"></i> Profile</a>
                </div>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <tr>
                  <?php if(is_array($list_data) || $list_data === 0){ ?>
                  <?php $no = 1;?>
                  <?php foreach($list_data as $dd): ?>
                    ...
                    <td><?=$dd->satuan?></td>
                    <td><?=$dd->jumlah?></td>
                    <td><img style="width: 100px;" src="<?php echo base_url().'assets/qrcode/images/'.$dd->qr_code;?>"></td>
