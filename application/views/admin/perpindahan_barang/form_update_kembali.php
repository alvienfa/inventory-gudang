            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="tanggal_keluar" style="margin-left:66px;width:20%;display:inline;" class="form-control form_datetime" readonly="readonly" value="<?=$d->tanggal_keluar?>" >
                </div>
                <div class="form-group">
                  <label for="tanggal_kembali" style="margin-left:220px;display:inline;">Tanggal Kembali</label>
                  <input type="text" name="tanggal_kembali" style="margin-left:66px;width:20%;display:inline;" class="form-control" required="" placeholder="Klik Disini" >
                </div>
