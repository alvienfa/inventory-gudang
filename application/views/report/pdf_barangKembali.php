...
<div>
    ...
    <table border="0" width="100%">
        <thead>
            ...
            <tr>
                ...
                <td style="width:200px"><?= $list_data->id_transaksi ?></td>
            ...
            <tr>
                <td>Hari / Tanggal</td>
                <td>:</td>
                <td><?= date('l / d F Y', strtotime($list_data->tanggal_kembali)) ?></td>
                <td></td>
                <td></td>
                <td>No. Handphone</td>
                <td>:</td>
    ...
    <table border="1" cellspacing="0" cellpadding="7">
        ...
        <tr>
            ...
            <th align="center" style="width: 140px;height: 40px;">Kode</th>
            <th align="center"  >Nama </th>
            <th align="center"  >Tipe Barang</th>
            <th align="center" style="width: 160px;"  >Tanggal Keluar</th>
            <th align="center" style="width: 160px;" >Tanggal Kembali</th>
        ...
        <tr>
            ...
            <td align="center" ><?= date('d F Y', strtotime($list_data->tanggal_kembali)) ?></td>
            <td align="center"  ><?= $list_data->text_status ?></td>
            <td align="center"  ><?= $list_data->jumlah ?> <?= $list_data->satuan ?></td>
        </tr>

        <tr>
            <td align="center" colspan="6" height="40px"><b>Jumlah</b></td>
            <td align="center"><?= $list_data->jumlah ?> <?= $list_data->satuan ?></td>
        </tr>
    </table><br><br>
    <table>
